...
key pairs and another for committing to messages. This models the fact that the Committer
is able to keep state and make random choice, while the commitments he makes
...
key-based commitment schemes with the only except all references to
...
and model uniform distributions of messages and randomness by the provided
...
\end{lstlisting}
  ...
  We prove that for any choice of $b$ the two procedures and
