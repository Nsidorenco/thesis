...
In our definitions of hiding and binding we do not have a formalisation of the statistical variant, since it is still unclear how to express those in EC \todo{reference}
...
convert to adversarial proofs. \todo{rewrite this}
