...
We opted to restrictive shvzk to perfect zero-knowledge since it is easier to
work with.
...
proof assistant whilst reflecting on how to improve previous work.
...
The AND construction works by running both protocol in parallel. The first
