...
The procedure $\texttt{simulate}$ is a wrapper around
...
Next we prove that if all the openings in the responses opens to the same views
...
\begin{proof}
  ...
  From this we use \validviews{c, w_1, w_2, w_3} prove that the computation
  ...
  This follows directly from \validviews{c, w_1, w_2, w_3} since at any step of
  ...
  matching $w_{1}, w_{2}, w_{3}$, which by our assumption of \validviews{c, w_1,
  w_2, w_3} have output shares summing to $y$. We can therefore conclude that a
