...
\todo{remove paragraphs and make definitions with text below.}
...
efficient \todo{what is efficient?} algorithm, which we call the ``witness\_extractor'',
that given the two transcripts outputs a valid witness for the relation $R$.
\end{definition}

\paragraph{SHVZK}
\todo{Write zero-knowledge section and reference it}
